...
import { Bot, Sparkles, Send, Stethoscope, AlertTriangle, ArrowRight, MessageSquare } from 'lucide-react';
    ...
    <div className="card p-5 bg-gradient-to-r from-bg-card via-bg-surface to-bg-card border-accent/40 shadow-xl space-y-4">
      ...
      <div className="flex-between">
        <div className="flex items-center gap-3">
          <div className="p-2.5 rounded-2xl bg-accent-glow border border-accent/40 text-accent-cyan">
        ...
        <button className="btn btn-secondary btn-sm flex items-center gap-1.5" onClick={() => setIsCommandPaletteOpen(true)}>
          <Sparkles className="w-3.5 h-3.5 text-accent-cyan" /> Cmd+K Command Palette
        </button>
      </div>
