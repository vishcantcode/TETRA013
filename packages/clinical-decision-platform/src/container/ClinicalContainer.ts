...
export class ClinicalContainer {
  private static instance: ClinicalContainer;
  ...
  public static getInstance(): ClinicalContainer {
    if (!ClinicalContainer.instance) {
      ClinicalContainer.instance = new ClinicalContainer();
    }
    return ClinicalContainer.instance;
  }
}
